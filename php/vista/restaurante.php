            ...
            <div class="container">
                ...
                ?>
                         <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                           <h3 class="titulo2"> <?php echo $row['nombreRest']; ?> </h3>
                           <br>
                           <br>
                             <a href="infoRestaurante.php?idRest=<?php echo $row['idRest']; ?>"><img class="cateimg zoom"  src="data:image/png;base64,<?php echo base64_encode($row['imgRest']); ?>" alt="" method="post"></a>
                         </div>
                <?php
                $i++;
                if ($i%2==0) {
