        ...
        <nav class="navbar navbar-default navbar-inverse navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="homeClient.php"><img class="img-responsive" img src="../../img/logomf.png" style="width: 43px; height: 43px; float: left; margin-top: -10px; padding-bottom: 2px; margin-right: 3px;">Metro<span class="icono">Food</span></a>
                </div>
                ...
                $i=0;
                  ...
                  $query = "SELECT * FROM platillo WHERE idRest='$idRest'";
                  $resultado = $conexion->query($query);
                  $query2 = "SELECT * FROM restaurante WHERE idRest='$idRest'";
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h5 class="titulo3"> <?php echo $row2['nombreRest']; ?> </h5>
                    <br>
                    <br>
                      <a href="#"><center><img class="img-circle circulo" src="data:image/png;base64,<?php echo base64_encode($row2['imgRest']); ?>" alt=""></center></a>
                      <br>
                      <br>
                      <div class="titulo2">
                        <?php echo $row2['descRest']; ?>
                      </div>
                  </div>
                  <div class="container-fluid cuerpo">
                  </div>
