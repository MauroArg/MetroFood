...
<!--muestreo de categorias-->
      ...
      ?>
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                 <h3 class="titulo2"> <?php echo $row['nombreCat']; ?> </h3>
                 <br>
                 <br>
                   <a href="Platillos.php?idCat=<?php echo $row['idCat']; ?>"><img class="cateimg zoom"  src="data:image/png/jpeg;base64,<?php echo base64_encode($row['imgCat']); ?>" alt="no carga" method="post"></a>
               </div>
      <?php
      $i++;
      if ($i%2==0) {
